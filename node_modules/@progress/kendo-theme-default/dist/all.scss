...
$card-header-bg: $header-bg !default;
...
// Breadcrumb
$breadcrumb-padding-x: $padding-x !default;
...
$breadcrumb-icon-font-size: $icon-size * .75 !default;
$breadcrumb-icon-padding-x: $padding-x-lg / 2 !default;
$breadcrumb-icon-padding-y: 0 !default;
...
@include exports( "breadcrumb/layout" ) {
    ...
    .k-breadcrumb {
        ...
        .k-breadcrumb-item .k-link {
            white-space: nowrap;
        }

        .k-breadcrumb-last-item .k-link {
            white-space: nowrap;
            overflow: hidden;
            text-overflow: ellipsis;
        }
        ...
        .k-breadcrumb-icon {
            padding: $breadcrumb-icon-padding-y $breadcrumb-icon-padding-x;
            font-size: $breadcrumb-icon-font-size;
            opacity: $disabled-opacity;
        }

        .k-breadcrumb-overflow-icon {
            padding: 0 0 0 $breadcrumb-icon-padding-x;
        }
        .k-breadcrumb-overflow-icon + .k-breadcrumb-overflow-icon {
            padding: 0 $breadcrumb-icon-padding-x 0 0;
        }
