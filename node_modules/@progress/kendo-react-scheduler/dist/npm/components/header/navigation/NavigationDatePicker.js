...
exports.NavigationDatePicker = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement(kendo_react_dateinputs_1.DatePicker, __assign({ ref: ref, dateInput: EMPTY_DATE_INPUT, pickerWrap: EMPTY_PICKER_WRAP, toggleButton: SchedulerNavigationDatePickerToggleButton, width: "auto" }, props, { value: value, onChange: handleChange })));
});
...
var SchedulerNavigationDatePickerToggleButton = function (props) {
    ...
    var _a = (0, SchedulerContext_1.useSchedulerDateFormatContext)(), dateFormat = _a.dateFormat, shortDateFormat = _a.shortDateFormat;
    ...
    var shortText = intl.format(shortDateFormat, isMonthView
        ...
        ? date
        : dateRange.zonedEnd.addDays(-1));
    return (React.createElement(kendo_react_buttons_1.Button, __assign({}, props, { className: "k-nav-current", tabIndex: -1, fillMode: 'flat' }),
