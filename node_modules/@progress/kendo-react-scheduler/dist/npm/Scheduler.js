...
exports.Scheduler = React.forwardRef(function (props, ref) {
    ...
    var className = React.useMemo(function () { return (0, kendo_react_common_1.classNames)({ 'k-rtl': props.rtl !== undefined ? props.rtl : dir === 'rtl' }, 'k-widget k-scheduler k-scheduler-flex k-floatwrap', props.className); }, [props.className, props.rtl, dir]);
    ...
    , { 
        ...
        React.createElement("div", { ref: element, id: props.id, style: style, className: className, tabIndex: props.tabIndex, 
            ...
            React.createElement(Header, null,
                React.createElement(Navigation, null,
                    React.createElement(kendo_react_buttons_1.ButtonGroup, { className: "k-scheduler-navigation" },
                        ...
                        React.createElement(kendo_react_buttons_1.Button, { role: "button", tabIndex: -1, icon: 'arrow-60-left', title: previousText, "aria-label": previousText, onClick: handlePrevClick }),
                        React.createElement(kendo_react_buttons_1.Button, { role: "button", tabIndex: -1, icon: 'arrow-60-right', title: nextText, "aria-label": nextText, onClick: handleNextClick }))),
            ...
            React.createElement(Footer, null, (slotDuration && slotDuration < (24 * 60)) && (React.createElement(BussinessHours_1.BusinessHours, null,
                React.createElement(kendo_react_buttons_1.Button, { tabIndex: -1, onClick: handleShowWorkHoursClick },
