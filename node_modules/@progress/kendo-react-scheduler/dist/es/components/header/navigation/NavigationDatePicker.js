...
export var NavigationDatePicker = React.forwardRef(function (props, ref) {
    ...
    return (React.createElement(DatePicker, __assign({ ref: ref, dateInput: EMPTY_DATE_INPUT, pickerWrap: EMPTY_PICKER_WRAP, toggleButton: SchedulerNavigationDatePickerToggleButton, width: "auto" }, props, { value: value, onChange: handleChange })));
});
...
var SchedulerNavigationDatePickerToggleButton = function (props) {
    ...
    var shortText = intl.format(shortDateFormat, isMonthView
        ...
        ? date
        : dateRange.zonedEnd.addDays(-1));
    return (React.createElement(Button, __assign({}, props, { className: "k-nav-current", tabIndex: -1, fillMode: 'flat' }),
